                        ...
                        <div class="flex flex-col flex-1 justify-center mb-8">
                            ...
                            <div class="w-full mt-4">
                                ...
                                <div class="flex flex-col mt-4">
                                        ...
                                        <input id="confirm" type="text" class="flex-grow h-8 px-2 rounded border border-grey-400" name="username">
                                        <span class="text-red-900"><?php $_SESSION["errors"]["username"] ?></span>
                                    </div>
                                    <div class="flex flex-col mt-4">
                                        ...
                                        <span class="text-red-900"><?php $_SESSION["errors"]["password"] ?></span>
                                    </div>
                                    <div class="flex flex-col mt-4">
                                        ...
                                        <span class="text-red-900"><?php $_SESSION["errors"]["confirm"] ?></span>
                                    </div>
                                    <div class="flex flex-col mt-4">
                                        ...
                                        <span class="text-red-900"><?php $_SESSION["errors"]["age"] ?></span>
                                    </div>
